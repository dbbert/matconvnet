...
%           randomVectors = gpuArray.ones(1,1,vectorSize,opts.batchSize,'single') ;
          ...
          images = generatorNet.vars(generatorNet.getVarIndex('deblock1_tanh')).value ;
...
%           discriminatorNet.eval({'input', images, 'embedding', randomVectors, 'label', labels}, opts.derOutputs) ;
          ...
          generatorNet.eval({'input', randomVectors}, {'deblock1_tanh', discriminatorNet.vars(1).der}) ;
...
%           randomVectors = gpuArray.ones(1,1,vectorSize,opts.batchSize/2,'single') ;
          ...
          % put half real, half generated images in the batch.
          images = cat(4, inputs{2}(:,:,:,1:end/2), generatorNet.vars(generatorNet.getVarIndex('deblock1_tanh')).value) ;
