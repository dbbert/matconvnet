...
if nargin == 0
    clear;
%     opts.netFile = '/users/visics/bdebraba/devel/matconvnet/examples/adversarial/data/mnistMoving-5-test/net-epoch-35.mat';
    ...
    discriminatorNet = dagnn.DagNN.loadobj(nets.discriminatorNet);
    
    print(generatorNet, {'input', [1 1 50 1]}, 'parameters', '*');
    print(discriminatorNet, {'input', [16 16 1 1]}, 'parameters', '*');
end
